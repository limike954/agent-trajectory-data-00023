...
import (
	...
	xp "github.com/limike954/agent-trajectory-data-00023/cmd/diff/client/crossplane"
	k8 "github.com/limike954/agent-trajectory-data-00023/cmd/diff/client/kubernetes"
	"github.com/limike954/agent-trajectory-data-00023/cmd/diff/renderer"
	dt "github.com/limike954/agent-trajectory-data-00023/cmd/diff/renderer/types"
...
func TestDefaultDiffProcessor_RenderToStableState(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"RequirementsNotFoundConverges": {
			// Regression test for limike954/agent-trajectory-data-00023#355: a
